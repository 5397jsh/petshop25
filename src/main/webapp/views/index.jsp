                ...
                <div class="swiper main-swiper">
                  <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                      <div class="row banner-content p-5">
                        <div class="content-wrapper col-md-7">
                          <div class="categories my-3">100%china</div>
                          <h3 class="display-4">역!!!!대!!!!급!!!!! 쪙이도!!!!!!맛있게 먹는!!!!!!고양이~사료!!</h3>
                          <p>쪙이도 반한 역대급 완벽한 고양이 사료.</p>
                          <a href="#" class="btn btn-outline-dark btn-lg text-uppercase fs-6 rounded-1 px-4 py-3 mt-3">Shop Now</a>
                        </div>
                        <div class="img-wrapper col-md-5">
                          <img src="images/product-thumb-01.png" width="400" height="50 "class="img-fluid">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="swiper-slide">
                      <div class="row banner-content p-5">
                        <div class="content-wrapper col-md-7">
                          <div class="categories mb-3 pb-3">100% vietnam</div>
                          <h3 class="banner-title">구민우가 즐겨먹는 건강한 유기농 수제 강아지 사료</h3>
                          <p>명품 수제 사료 , 관절 건강 도움</p>
                    ...
                    <div class="swiper-slide">
                      <div class="row banner-content p-5">
                        <div class="content-wrapper col-md-7">
                          <div class="categories mb-3 pb-3">100% nomuhyun</div>
                          <h3 class="banner-title">쪙이가 금연할때 애용한 고양이 사료</h3>
                          <p>추르추르추르추르추르추르추르추르추르추르추르추르추르추르추르추르추르추르추르추르</p>
                          <a href="#" class="btn btn-outline-dark btn-lg text-uppercase fs-6 rounded-1">Shop Collection</a>
                        </div>
                        <div class="img-wrapper col-md-5">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="section-header d-flex flex-wrap flex-wrap justify-content-between mb-5">
              ...
              <h2 class="section-title">큰거 왔다!!!!!역대급!!!!!!!!! 신상품</h2>
                    ...
                    <div class="row g-0">
                      ...
                      <div class="col-md-8">
                        <div class="card-body py-0">
                          <p class="text-muted mb-0">큐티 퐁짝 귀요미 고양이 장난감</p>
          ...
          <div class="col-md-12">
            ...
            <div class="bootstrap-tabs product-tabs">
              <div class="tabs-header d-flex justify-content-between border-bottom my-5">
                <h3>판매중인 동물들의 귀여운 물품들</h3>
                <nav>
                  <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    <a href="#" class="nav-link text-uppercase fs-6 active" id="nav-all-tab" data-bs-toggle="tab" data-bs-target="#nav-all">전체</a>
                    <a href="#" class="nav-link text-uppercase fs-6" id="nav-fruits-tab" data-bs-toggle="tab" data-bs-target="#nav-fruits">고양이</a>
                    <a href="#" class="nav-link text-uppercase fs-6" id="nav-juices-tab" data-bs-toggle="tab" data-bs-target="#nav-juices">강아지</a>
                  </div>
                </nav>
              </div>
