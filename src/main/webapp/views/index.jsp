              ...
              <div class="row">
                ...
                <div class="col-md-10">
                  <div class="card-body p-0">
                    <h5>구민우</h5>
                    <p class="card-text">키173.8cm 몸무게 95.6kg  그곳 최대길이 13cm</p>
                  </div>
                </div>
              </div>
              </div>
            ...
            <div class="card mb-3 border-0">
              <div class="row">
                ...
                <div class="col-md-10">
                  <div class="card-body p-0">
                    <h5>정승혁</h5>
                    <p class="card-text">키186cm 몸무게 134.6kg 그곳 최대길이 23cm</p>
                  </div>
                </div>
              </div>
              </div>
            ...
            <div class="card mb-3 border-0">
              <div class="row">
                ...
                <div class="col-md-10">
                  <div class="card-body p-0">
                    <h5>김우성 </h5>
                    <p class="card-text">키 169.6 몸무게 78.4kg  그곳 최대길이 6cm</p>
                  </div>
                </div>
              </div>
              </div>
